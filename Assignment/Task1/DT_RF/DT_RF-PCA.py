...
print(f"Elapsed time to classify the data using Decision Three (PCA) Classifier: {elapsed_time/60:.2f} minutes")
...
print('\nDecision Tree (PCA) Accuracy Score on Test data: {}%'.format(DT_accuracy))
print('\nDecision Tree (PCA) Precision Score on Test data: {}%'.format(DT_precision))
print('\nDecision Tree (PCA) Recall Score on Test data: {}%'.format(DT_recall))
...
titles_options = [
    ("Decision Three (PCA) Confusion Matrix", None),
    #("Decision Three (PCA) Normalized Confusion Matrix", "true"),
]
...
elapsed_time = time.time() - start_time
print(f"\nElapsed time to classify the data using Decision Three (PCA) Classifier after hyperparameters tuning: {elapsed_time/60:.2f} minutes")
...
print('\nDecision Tree (PCA) (after tuning) Accuracy Score on Test data: {}%'.format(DT2_accuracy))
print('\nDecision Tree (PCA) (after tuning) Precision Score on Test data: {}%'.format(DT2_precision))
print('\nDecision Tree (PCA) (after tuning) Recall Score on Test data: {}%'.format(DT2_recall))


# 7. Plot non-normalized confusion matrix after tuning
titles_options = [
    ("PCA Decision Three Confusion Matrix After Tuning", None),
    #("PCA Decision Three Normalized confusion matrix", "true"),
]
for title, normalize in titles_options:
    disp = ConfusionMatrixDisplay.from_estimator(
        dt_clf,
...
elapsed_time = time.time() - start_time
print(f"\nElapsed time to classify the data using Random Forest (PCA) Classifier: {elapsed_time/60:.2f} minutes")
...
print('\nRandom Forest (PCA) Accuracy Score on Test data: {}%'.format(RF_accuracy))
print('\nRandom Forest (PCA) Precision Score on Test data: {}%'.format(RF_accuracy))
print('\nRandom Forest (PCA) Recall Score on Test data: {}%'.format(RF_accuracy))
...
# 4. Plot non-normalized confusion matrix
titles_options = [
    ("Random Forest (PCA) Confusion Matrix", None),
    #("Random Forest (PCA) Normalized Confusion Matrix", "true"),
]
for title, normalize in titles_options:
    disp = ConfusionMatrixDisplay.from_estimator(
        rf_clf,
