...
print("\nVector Size (number of features): {}".format(len(images_vectors[0])))
...
print('\nSVM with ANOVA Accuracy Score on Test data: {}\n'.format(round(metrics.accuracy_score(Y_test,Y_pred),3)*100))

# 4. Plot non-normalized confusion matrix
titles_options = [
    ("SVM (with ANOVA) Confusion matrix, without normalization", None),
