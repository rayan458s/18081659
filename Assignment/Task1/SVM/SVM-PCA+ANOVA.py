...
for image_vector in images_vectors:
    ...
    single_image_feature = []
print("\nNumber of features after PCA: {}".format(k_PCA))

#Select Features using ANOVA
k_anova = 10
images_features = dt.select_features_with_ANOVA(images_features, labels, k_anova)
print("\nNumber of features after ANOVA: {}".format(len(images_features[1])))
...
Y_pred, svm_clf = dt.SVM_Classifier(X_train, Y_train, X_test,"rbf")
