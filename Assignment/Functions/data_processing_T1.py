...
def process_ANOVA_features(k_ANOVA):
    ...
    file_path = '/Users/rayan/PycharmProjects/AMLS/Assignment/Task1/Features/ANOVA-'+str(k_ANOVA)+'.dat'    #file path tos ave the computed features
...
def process_PCA_features(k_PCA):
    ...
    file_path = '/Users/rayan/PycharmProjects/AMLS/Assignment/Task1/Features/PCA-'+str(k_PCA)+'.dat'   #file path tos ave the computed features
...
def get_ANOVA_features(k_ANOVA):
    ...
    '''
    file_path = '/Users/rayan/PycharmProjects/AMLS/Assignment/Task1/Features/ANOVA-'+str(k_ANOVA)+'.dat'      #get filepath where we saved the previously computed features
...
def get_PCA_features(k_PCA):
    ...
    Return
        PCA_features: A numpy array containing every image as a vector of PCA projected features
    '''
    file_path = '/Users/rayan/PycharmProjects/AMLS/Assignment/Task1/Features/PCA-'+str(k_PCA)+'.dat'   #get filepath where we saved the previously computed features
